...
class ChatRequest(BaseModel):
    ...
    top_k: int = Field(40, ge=1, le=100, description="تعداد کلمات برتر")
    repetition_penalty: float = Field(1.5, ge=1.0, le=2.0, description="جلوگیری از تکرار")
    no_repeat_ngram_size: int = Field(4, ge=1, le=5, description="جلوگیری از تکرار n-gram")
